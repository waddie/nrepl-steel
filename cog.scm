...
(define dylibs
  '((#:name
     ...
     ((#:platform
       "aarch64-macos"
       #:url
       "https://github.com/waddie/nrepl-steel/releases/download/v0.2.4/libnrepl_steel_engine-aarch64-macos.dylib")
      (#:platform
       "x86_64-macos"
       #:url
       "https://github.com/waddie/nrepl-steel/releases/download/v0.2.4/libnrepl_steel_engine-x86_64-macos.dylib")
      (#:platform
       "x86_64-linux"
       #:url
       "https://github.com/waddie/nrepl-steel/releases/download/v0.2.4/libnrepl_steel_engine-x86_64-linux.so")
      (#:platform
       "x86_64-windows"
       #:url
       "https://github.com/waddie/nrepl-steel/releases/download/v0.2.4/nrepl_steel_engine-x86_64-windows.dll")))))
